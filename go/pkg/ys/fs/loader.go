...
func LoadNS() {
	...
	// cp-r
	{
		...
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			...
			tmp5 := lang.NewMap(kw_file, "ys/fs.glj", kw_line, int(243), kw_column, int(5), kw_end_DASH_line, int(252), kw_end_DASH_column, int(10))
	...
	// mktemp
	{
		tmp0 := sym_mktemp.WithMeta(lang.NewMap(kw_file, "ys/fs.glj", kw_line, int(294), kw_column, int(7), kw_end_DASH_line, int(294), kw_end_DASH_column, int(12), kw_arglists, lang.NewList(lang.NewVector(), lang.NewVector(sym_prefix), lang.NewVector(sym_dir, sym_prefix)), kw_doc, "Create temporary file and return path", kw_ns, lang.FindOrCreateNamespace(sym_ys_DOT_fs))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			case 0:
			...
			case 2:
				...
				{ // let
					...
					if lang.IsTruthy(tmp15) {
						...
						tmp19, ok := lang.FieldOrMethod(v9, "Name")
						if !ok {
		...
		if tmp0.Meta() != nil {
			var_ys_DOT_fs_mktemp.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// mktemp-d
	{
		tmp0 := sym_mktemp_DASH_d.WithMeta(lang.NewMap(kw_file, "ys/fs.glj", kw_line, int(304), kw_column, int(7), kw_end_DASH_line, int(304), kw_end_DASH_column, int(14), kw_arglists, lang.NewList(lang.NewVector(), lang.NewVector(sym_prefix), lang.NewVector(sym_dir, sym_prefix)), kw_doc, "Create temporary directory and return path", kw_ns, lang.FindOrCreateNamespace(sym_ys_DOT_fs))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			case 0:
		...
		if tmp0.Meta() != nil {
			var_ys_DOT_fs_mktemp_DASH_d.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// multi
	{
