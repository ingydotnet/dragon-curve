...
func LoadNS() {
	...
	// process
	{
		tmp0 := sym_process.WithMeta(lang.NewMap(kw_file, "ys/ipc.glj", kw_line, int(54), kw_column, int(7), kw_end_DASH_line, int(54), kw_end_DASH_column, int(13), kw_arglists, lang.NewList(lang.NewVector(sym__AMP_, sym_args)), kw_ns, lang.FindOrCreateNamespace(sym_ys_DOT_ipc))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			default:
		...
		if tmp0.Meta() != nil {
			var_ys_DOT_ipc_process.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// sh
	{
		tmp0 := sym_sh.WithMeta(lang.NewMap(kw_file, "ys/ipc.glj", kw_line, int(22), kw_column, int(7), kw_end_DASH_line, int(22), kw_end_DASH_column, int(8), kw_arglists, lang.NewList(lang.NewVector(sym__AMP_, sym_args)), kw_ns, lang.FindOrCreateNamespace(sym_ys_DOT_ipc))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			default:
							...
							{ // let
								...
								if lang.IsTruthy(tmp60) {
									...
									{ // let
										...
										tmp83, ok := lang.FieldOrMethod(v26, "Wait")
										if !ok {
											panic(lang.NewIllegalArgumentError(fmt.Sprintf("no such field or method on %T: %s", v26, "Wait")))
										}
										var tmp84 any
										switch reflect.TypeOf(tmp83).Kind() {
										case reflect.Func:
											tmp84 = lang.Apply(tmp83, nil)
										default:
											tmp84 = tmp83
										}
										var v85 any = tmp84
										...
										if lang.IsTruthy(tmp88) {
											...
											tmp89, ok := lang.FieldOrMethod(v26, "ProcessState")
											if !ok {
											...
											tmp91, ok := lang.FieldOrMethod(tmp90, "ExitCode")
											if !ok {
												panic(lang.NewIllegalArgumentError(fmt.Sprintf("no such field or method on %T: %s", tmp90, "ExitCode")))
											}
											var tmp92 any
											switch reflect.TypeOf(tmp91).Kind() {
											case reflect.Func:
												tmp92 = lang.Apply(tmp91, nil)
											default:
												tmp92 = tmp91
											}
											tmp86 = tmp92
										...
										tmp104 := lang.NewMap(kw_exit, v93, kw_out, tmp94, kw_err, tmp99)
										tmp105 := lang.NewMap(kw_file, "ys/ipc.glj", kw_line, int(41), kw_column, int(15), kw_end_DASH_line, int(47), kw_end_DASH_column, int(26))
										tmp106, err := lang.WithMeta(tmp104, tmp105.(lang.IPersistentMap))
										if err != nil {
											panic(err)
										}
										tmp66 = tmp106
		...
		if tmp0.Meta() != nil {
			var_ys_DOT_ipc_sh.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// shell
	{
		tmp0 := sym_shell.WithMeta(lang.NewMap(kw_file, "ys/ipc.glj", kw_line, int(49), kw_column, int(7), kw_end_DASH_line, int(49), kw_end_DASH_column, int(11), kw_arglists, lang.NewList(lang.NewVector(sym__AMP_, sym_args)), kw_ns, lang.FindOrCreateNamespace(sym_ys_DOT_ipc))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			default:
		...
		if tmp0.Meta() != nil {
			var_ys_DOT_ipc_shell.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
}
