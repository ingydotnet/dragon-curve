...
func LoadNS() {
	...
	// cond-lets
	{
		tmp0 := sym_cond_DASH_lets.WithMeta(lang.NewMap(kw_macro, true, kw_arglists, lang.NewList(lang.NewVector(sym__AMP_, sym_clauses)), kw_doc, "Like cond-let but with more than one binding", kw_file, "yamlscript/util.glj", kw_ns, lang.FindOrCreateNamespace(sym_yamlscript_DOT_util), kw_end_DASH_column, int(19), kw_column, int(11), kw_line, int(17), kw_end_DASH_line, int(17), kw_style_SLASH_indent, lang.NewVector(int64(0)))).(*lang.Symbol)
	...
	// condf
	{
		tmp0 := sym_condf.WithMeta(lang.NewMap(kw_macro, true, kw_arglists, lang.NewList(lang.NewVector(sym_x, sym__AMP_, sym_clauses)), kw_doc, "Like condp but with a function", kw_file, "yamlscript/util.glj", kw_ns, lang.FindOrCreateNamespace(sym_yamlscript_DOT_util), kw_end_DASH_column, int(15), kw_column, int(11), kw_line, int(12), kw_end_DASH_line, int(12))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			default:
	...
	// die
	{
		tmp0 := sym_die.WithMeta(lang.NewMap(kw_file, "yamlscript/util.glj", kw_line, int(6), kw_column, int(7), kw_end_DASH_line, int(6), kw_end_DASH_column, int(9), kw_arglists, lang.NewList(lang.NewVector(), lang.NewVector(sym_msg), lang.NewVector(sym_x, sym__AMP_, sym_xs)), kw_doc, "Throw a string as an exception", kw_ns, lang.FindOrCreateNamespace(sym_yamlscript_DOT_util))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			case 0:
	...
	// eprint
	{
		tmp0 := sym_eprint.WithMeta(lang.NewMap(kw_file, "yamlscript/util.glj", kw_line, int(28), kw_column, int(7), kw_end_DASH_line, int(28), kw_end_DASH_column, int(12), kw_arglists, lang.NewList(lang.NewVector(sym__AMP_, sym_xs)), kw_doc, "Print to stderr", kw_ns, lang.FindOrCreateNamespace(sym_yamlscript_DOT_util))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			default:
	...
	// eprintln
	{
		tmp0 := sym_eprintln.WithMeta(lang.NewMap(kw_file, "yamlscript/util.glj", kw_line, int(34), kw_column, int(7), kw_end_DASH_line, int(34), kw_end_DASH_column, int(14), kw_arglists, lang.NewList(lang.NewVector(sym__AMP_, sym_xs)), kw_doc, "Print to stderr with a newline", kw_ns, lang.FindOrCreateNamespace(sym_yamlscript_DOT_util))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			default:
	...
	// if-lets
	{
		tmp0 := sym_if_DASH_lets.WithMeta(lang.NewMap(kw_macro, true, kw_arglists, lang.NewList(lang.NewVector(sym_bindings, sym_then), lang.NewVector(sym_bindings, sym_then, sym_else)), kw_doc, "Like if-let but with more than one binding", kw_file, "yamlscript/util.glj", kw_ns, lang.FindOrCreateNamespace(sym_yamlscript_DOT_util), kw_end_DASH_column, int(17), kw_column, int(11), kw_line, int(40), kw_end_DASH_line, int(40))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			case 4:
	...
	// macro?
	{
		tmp0 := sym_macro_QMARK_.WithMeta(lang.NewMap(kw_file, "yamlscript/util.glj", kw_line, int(51), kw_column, int(7), kw_end_DASH_line, int(51), kw_end_DASH_column, int(12), kw_arglists, lang.NewList(lang.NewVector(sym_x)), kw_doc, "Check if a symbol is a macro", kw_ns, lang.FindOrCreateNamespace(sym_yamlscript_DOT_util))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 1)
			v2 := args[0]
	...
	// type-name
	{
		tmp0 := sym_type_DASH_name.WithMeta(lang.NewMap(kw_file, "yamlscript/util.glj", kw_line, int(59), kw_column, int(7), kw_end_DASH_line, int(59), kw_end_DASH_column, int(15), kw_arglists, lang.NewList(lang.NewVector(sym_x)), kw_doc, "Get the name of a type", kw_ns, lang.FindOrCreateNamespace(sym_yamlscript_DOT_util))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 1)
			v2 := args[0]
	...
	// when-lets
	{
		tmp0 := sym_when_DASH_lets.WithMeta(lang.NewMap(kw_macro, true, kw_arglists, lang.NewList(lang.NewVector(sym_bindings, sym__AMP_, sym_body)), kw_doc, "Like when-let but with more than one binding", kw_file, "yamlscript/util.glj", kw_ns, lang.FindOrCreateNamespace(sym_yamlscript_DOT_util), kw_end_DASH_column, int(19), kw_column, int(11), kw_line, int(70), kw_end_DASH_line, int(70))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			default:
