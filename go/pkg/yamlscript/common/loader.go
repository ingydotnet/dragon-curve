...
func LoadNS() {
	...
	// chop
	{
		tmp0 := sym_chop.WithMeta(lang.NewMap(kw_file, "yamlscript/common.glj", kw_line, int(32), kw_column, int(7), kw_end_DASH_line, int(32), kw_end_DASH_column, int(10), kw_arglists, lang.NewList(lang.NewVector(sym_S), lang.NewVector(sym_N, sym_S)), kw_ns, lang.FindOrCreateNamespace(sym_yamlscript_DOT_common))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			case 1:
		...
		if tmp0.Meta() != nil {
			var_yamlscript_DOT_common_chop.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// re-find+
	{
